...
from vmapi.views import register_user, login_user, AssignmentView, StatusView, VolunteerView, VolunteerAssignmentView, Users
...
router.register(r'volunteer_assignments', VolunteerAssignmentView, 'volunteer assignment')
